                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__links">
                            <a href="{{ route('mangol.index') }}"><i class="fa fa-home"></i> Home</a>
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-3">
                            <div class="anime__details__pic set-bg" data-setbg="{{ asset('storage/img/'.$comic->image) }}">
                            </div>
                        </div>
                        <div class="col-lg-9">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <ul class="content-info-manga">
                                                ...
                                                <li><span>Released:</span>{{ $comic->released }}</li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <ul class="content-info-manga">
                                            ...
                                            <ul class="content-info-manga">
                                                <li><span>Genre:</span>
                                                    @foreach ($comic->genres as $genre)
                                                        <a href="#" class="btn genrebtn">{{ $genre->genre }}</a>
                                                    @endforeach
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-9 col-md-12">
                            <div class="series-chapter">
                                ...
                                @foreach ($comic->chapters()->orderBy('created_at', 'desc')->get() as $chapter)
                                    ...
                                    <li>
                                        <div class="flexch">
                                            ...
                                            <div class="flexch-infoz">
                                                <a href="{{ route('mangol.chapter', $chapter->id) }}"><span>{{ $chapter->title }}</span></a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="anime__details__form pt-5">
                                ...
                                <form action="{{ route('mangol.comments', $comic->id) }}" method="POST">
                                    @csrf
                                    <div class="row mb-2">
                                        <div class="col">
